...
return new class extends Migration
{
    public function up(): void
    {
        ...
        foreach (PermissionCatalog::definitions() as $definition) {
            if (! str_starts_with($definition['name'], 'appointment.appointment.')) {
                continue;
            }
        ...
        $legacyManage = Permission::query()
            ->where('name', 'appointment.appointment.manage')
    ...
    public function down(): void
    {
        ...
        Permission::query()->updateOrCreate(
            ['name' => 'appointment.appointment.manage', 'guard_name' => $guard],
            ['group' => 'appointment', 'label' => 'Manage Appointments', 'is_wildcard' => false],
        );
